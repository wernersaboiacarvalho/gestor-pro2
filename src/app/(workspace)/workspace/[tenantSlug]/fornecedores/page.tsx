...
import { Plus, Search, Truck, Phone, Mail, Package } from "lucide-react"
    ...
    <div>
      ...
      <form className="mb-6">
        <div className="relative max-w-md">
          ...
          <input name="q" defaultValue={q} placeholder="Buscar por nome ou CNPJ..." className="w-full rounded-lg border border-zinc-200 bg-white py-2 pl-10 pr-4 text-sm dark:border-zinc-800 dark:bg-zinc-900" />
        </div>
      </form>
